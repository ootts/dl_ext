...
@dispatch(str, list)
def load_label_2(absolute_path, interest_classes=default_interest_classes):
...
def load_label_2(label_2_dir, imgid, interest_classes=default_interest_classes):
...
def load_label_2(kitti_root, split, imgid, interest_classes=default_interest_classes):
...
def load_label_2(absolute_path):
    return load_label_2(absolute_path, default_interest_classes)


@dispatch(str, str)
def load_label_2(label_2_dir, imgid):
    return load_label_2(label_2_dir, imgid, default_interest_classes)
...
def load_label_2(kitti_root, split, imgid):
    return load_label_2(kitti_root, split, imgid, default_interest_classes)
